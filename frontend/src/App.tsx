        ...
        <NGOPlatformProvider>
          <Routes>
            ...
            <Route path="/ngo" element={<NGOLayout user={user} onLogout={handleLogout} />}>
              ...
              <Route path="data/:datasetId"         element={<DataManagementPage />} />
              ...
              <Route path="monitoring"              element={<StudyDashboard />} />
              ...
              <Route path="pipeline"                element={<NGOPipeline />} />
            </Route>
